export function SplitLayout({ children, image, imageAlt, eyebrow, title, subtitle, rightPanel }) {
  return (
    <section className="grid gap-10 px-6 py-10 sm:px-10 lg:grid-cols-2 lg:gap-16 lg:px-16 lg:py-16">
